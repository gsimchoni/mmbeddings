...
class ExperimentInput:
    ...
    def get(self):
        ...
        exp = ExpInput(
            ...
            n_sig2bs=self.n_sig2bs, verbose=self.params['verbose'], n_neurons_decoder=self.params['n_neurons_decoder'],
            n_neurons_encoder=self.params.get('n_neurons_encoder', self.params['n_neurons_decoder']),
